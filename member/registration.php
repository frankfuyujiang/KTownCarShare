...
<table cellspacing="50" align="center">
	...
	<tr>
		<td align="center">
			...
			<br>
			<div class="col-lg-12" align="left">
			Driver License:<INPUT CLASS="form-control" TYPE="TEXT" NAME = "DriverLic" placeholder="Driver License" size="20"/>
			</div>
			<div class="col-lg-12" align="left">
			Credit Card #: <Input class="form-control" Type="TEXT" NAME="CreditNum" placeholder="1234567890" size="20"/>
			<Input class="form-control" Type="TEXT" NAME="ExpireDate" placeholder="Ex Date" size="15"/>
			</div>
			<div class="col-lg-12" align="left">
